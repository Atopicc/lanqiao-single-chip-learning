...
unsigned char SetRTC_Data[7] = {0x23,0x08,0x13,0x06,0x23,0x59,0x54}; //年 月 日 星期 时 分 秒
unsigned char ReadRTC_Data[7] = {0x23,0x08,0x13,0x06,0x11,0x20,0x55};//年 月 日 星期 时 分 秒
